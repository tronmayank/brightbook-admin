...
const MOLVerticalNavbar = (props: Props) => {
  ...
  return (
    <div className="w-full h-full px-2 py-4 overflow-x-hidden overflow-y-auto border-r shadow bg-secondary-10">
        ...
        {navigation({ badgeData })?.map((navItem, navItemIndex) => {
          return (
            <div key={navItemIndex} className="flex flex-col gap-4">
              {/* <div className="flex items-center px-5 text-[12px] font-bold tracking-widest text-primary-70 uppercase ">
                {navItem?.groupLable}
              </div> */}
